...
**H2: Primates known to particpate in meat eating behaviors, such as the chimpanzee, will show selection on TAS1R1 and/or TAS1R3, as determined by comparison of the foreground branch model results and the null model results via a likelihood ratio test.**
...
While all above hypotheses have suggested positive selection, its possible that primates with very general diets or perhaps predominetly frugivorouus diets may not show selection:
...
# APPENDIX 
![Anticipated results based on hyptheses](pathway)
